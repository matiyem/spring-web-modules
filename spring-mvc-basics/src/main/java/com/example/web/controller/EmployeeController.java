...
public class EmployeeController {
    ...
    public void initEmployees() {
        ...
        employeeMap.put(2L, new Employee(2L, "Peter", "22001543", "informatices"));
    ...
    @RequestMapping(value = "/employee/{Id}", produces = {"application/xml","application/json"}, method = RequestMethod.GET)
    public @ResponseBody
