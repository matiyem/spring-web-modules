...
//        ارسال ایمیل با template thymeleaf
    ...
    public void sendMessageUsingFreemarkerTemplate(String to, String subject, Map<String, Object> templateModel) throws IOException, TemplateException, MessagingException {
        //ارسال ایمیل با استفاده از template freeMarker
        //این template زبان های غیر انگلیسی را ساپورت نمیکند
...
//        ما از MimeMessageHelper برای پر کردن پیام استفاده می کنیم. بخش مهم مقدار واقعی است که به متد setText ارسال می شود: نوع محتوای HTML را مشخص می کند.
//
        MimeMessage message=emailSender.createMimeMessage();
