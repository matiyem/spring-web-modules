...
public class GreetingsController {
    ...
    @RequestMapping(value = "greetings-with-response-body",method = RequestMethod.GET,produces = "application/json")
    @ResponseBody
    public String getGreetingWhileReturnTypeIsString(){
        return "{\"test\": \"Hello using @ResponseBody\"}";
    }
    @RequestMapping(value = "/greetings-with-response-entity",method = RequestMethod.GET,produces = "application/json")
    ...
    @RequestMapping(value = "/greetings-with-map-return-type",method = RequestMethod.GET,produces = "application/json")
    @ResponseBody
